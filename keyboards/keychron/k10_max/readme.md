...
![Keychron K10 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/K10-Max-1.jpg)

A customizable 108-key full-size keyboard.
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/k10_max/ansi/rgb:keychron
    make keychron/k10_max/ansi/white:keychron
    make keychron/k10_max/iso/rgb:keychron
    make keychron/k10_max/iso/white:keychron
    make keychron/k10_max/jis/rgb:keychron
    make keychron/k10_max/jis/white:keychron

Flashing example for this keyboard:

    make keychron/k10_max/ansi/rgb:keychron:flash
    make keychron/k10_max/ansi/white:keychron:flash
    make keychron/k10_max/iso/rgb:keychron:flash
    make keychron/k10_max/iso/white:keychron:flash
    make keychron/k10_max/jis/rgb:keychron:flash
    make keychron/k10_max/jis/white:keychron:flash
