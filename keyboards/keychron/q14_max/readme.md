...
![Keychron Q14 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/Q14-Max-page7.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/q14_max/ansi_encoder:keychron

Flashing example for this keyboard:

    make keychron/q14_max/ansi_encoder:keychron:flash
