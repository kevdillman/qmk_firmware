...
![Keychron K2 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/K2_Max1.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/k2_max/ansi/rgb:keychron
    make keychron/k2_max/ansi/white:keychron
    make keychron/k2_max/iso/rgb:keychron
    make keychron/k2_max/iso/white:keychron
    make keychron/k2_max/jis/rgb:keychron
    make keychron/k2_max/jis/white:keychron

Flashing example for this keyboard:

    make keychron/k2_max/ansi/rgb:keychron:flash
    make keychron/k2_max/ansi/white:keychron:flash
    make keychron/k2_max/iso/rgb:keychron:flash
    make keychron/k2_max/iso/white:keychron:flash
    make keychron/k2_max/jis/rgb:keychron:flash
    make keychron/k2_max/jis/white:keychron:flash
