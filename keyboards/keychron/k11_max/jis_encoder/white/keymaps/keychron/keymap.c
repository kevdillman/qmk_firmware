...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_73_jis(
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,               KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_BSLS,  KC_ENT,   KC_HOME,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_INT1,  KC_RSFT,  KC_UP,
        KC_LCTL,  KC_LWIN,  KC_LALT,  KC_INT5,  KC_SPC,             FN1_MAC,  MO(FN2),            KC_SPC,   KC_INT4,  KC_RALT,            KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MAC_FN1] = LAYOUT_73_jis(
        ...
        BL_TOGG,  BL_STEP,  BL_UP,    _______,  _______,  BL_SPI,             _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_END,
        _______,  _______,  BL_DOWN,  _______,  _______,  BL_SPD,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PGUP,
