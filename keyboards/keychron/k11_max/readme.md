...
![Keychron K11 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/K11-Max-page-5.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/k11_max/ansi_encoder/rgb:keychron
    make keychron/k11_max/ansi_encoder/white:keychron
    make keychron/k11_max/iso_encoder/rgb:keychron
    make keychron/k11_max/iso_encoder/white:keychron
    make keychron/k11_max/jis_encoder/rgb:keychron
    make keychron/k11_max/jis_encoder/white:keychron

Flashing example for this keyboard:

    make keychron/k11_max/ansi_encoder/rgb:keychron:flash
    make keychron/k11_max/ansi_encoder/white:keychron:flash
    make keychron/k11_max/iso_encoder/rgb:keychron:flash
    make keychron/k11_max/iso_encoder/white:keychron:flash
    make keychron/k11_max/jis_encoder/rgb:keychron:flash
    make keychron/k11_max/jis_encoder/white:keychron:flash
