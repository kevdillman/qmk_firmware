...
![Keychron K17 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/K17-Max-3.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/k17_max/ansi/rgb:keychron
    make keychron/k17_max/ansi/white:keychron
    make keychron/k17_max/iso/rgb:keychron
    make keychron/k17_max/iso/white:keychron
    make keychron/k17_max/jis/rgb:keychron
    make keychron/k17_max/jis/white:keychron

Flashing example for this keyboard:

    make keychron/k17_max/ansi/rgb:keychron:flash
    make keychron/k17_max/ansi/white:keychron:flash
    make keychron/k17_max/iso/rgb:keychron:flash
    make keychron/k17_max/iso/white:keychron:flash
    make keychron/k17_max/jis/rgb:keychron:flash
    make keychron/k17_max/jis/white:keychron:flash
