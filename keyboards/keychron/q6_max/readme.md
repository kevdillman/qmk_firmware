...
![Keychron Q6 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/Keychron-Q6-Max-100_-Layout-QMK_VIA-Wireless-Custom-Mechanical-Keyboard-White.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/q6_max/ansi_encoder:keychron
    make keychron/q6_max/iso_encoder:keychron

Flashing example for this keyboard:

    make keychron/q6_max/ansi_encoder:keychron:flash
    make keychron/q6_max/iso_encoder:keychron:flash
