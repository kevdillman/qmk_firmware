...
![Keychron K7 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/t/5/assets/pf-d1ce6496--KeychronK765percentultraslimcompactwirelessmechanicalkeyboardforMacWindowsHotswappablelowprofileGateronMechanicalandOpticalswitchesforMacWindowswithRGBbacklit.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/k7_max/ansi/rgb:keychron
    make keychron/k7_max/ansi/white:keychron
    make keychron/k7_max/iso/rgb:keychron
    make keychron/k7_max/iso/white:keychron
    make keychron/k7_max/jis_v2/rgb:keychron
    make keychron/k7_max/jis_v2/white:keychron

Flashing example for this keyboard:

    make keychron/k7_max/ansi/rgb:keychron:flash
    make keychron/k7_max/ansi/white:keychron:flash
    make keychron/k7_max/iso/rgb:keychron:flash
    make keychron/k7_max/iso/white:keychron:flash
    make keychron/k7_max/jis/rgb:keychron:flash
    make keychron/k7_max/jis/white:keychron:flash
    make keychron/k7_max/jis_v2/rgb:keychron:flash
    make keychron/k7_max/jis_v2/white:keychron:flash
