...
![Keychron Q15 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/Keychron_Q15_Max_ortholinear_wireless_QMK_customized_mechanical_keyboard-2.jpg)

A customizable ortholinear keyboard.
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/q15_max/ansi_encoder:keychron

Flashing example for this keyboard:

    make keychron/q15_max/ansi_encoder:keychron:flash
