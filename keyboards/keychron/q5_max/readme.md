...
![Keychron Q5 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/Q5-Max-1.jpg)

A customizable wireless 98% keyboard.
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/q5_max/iso_encoder:keychron
    make keychron/q5_max/jis_encoder:keychron

Flashing example for this keyboard:

    make keychron/q5_max/ansi_encoder:keychron:flash
    make keychron/q5_max/iso_encoder:keychron:flash
    make keychron/q5_max/jis_encoder:keychron:flash
