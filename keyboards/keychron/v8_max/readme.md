...
![Keychron V8 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/V8-Max-5.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/v8_max/ansi_encoder:keychron
    make keychron/v8_max/iso_encoder:keychron

Flashing example for this keyboard:

    make keychron/v8_max/ansi_encoder:keychron:flash
    make keychron/v8_max/iso_encoder:keychron:flash
