...
![Keychron Version 3](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/K3-Version-3-QMK-Wireless-Mechanical-Keyboard_9edfc06a-93bb-4f38-ab2f-4635e4685475.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/k3_version_3/ansi/rgb:keychron
    make keychron/k3_version_3/ansi/white:keychron
    make keychron/k3_version_3/iso/rgb:keychron
    make keychron/k3_version_3/iso/white:keychron
    make keychron/k3_version_3/jis/rgb:keychron
    make keychron/k3_version_3/jis/white:keychron

Flashing example for this keyboard:

    make keychron/k3_version_3/ansi/rgb:keychron:flash
    make keychron/k3_version_3/ansi/white:keychron:flash
    make keychron/k3_version_3/iso/rgb:keychron:flash
    make keychron/k3_version_3/iso/white:keychron:flash
    make keychron/k3_version_3/jis/rgb:keychron:flash
    make keychron/k3_version_3/jis/white:keychron:flash
