...
![Keychron V3 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/Keychron-V3-Max-wireless-mechanical-keyboard.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/v3_max/ansi_encoder:keychron
    make keychron/v3_max/iso_encoder:keychron
    make keychron/v3_max/jis_encoder:keychron
    
Flashing example for this keyboard:

    make keychron/v3_max/ansi_encoder:keychron:flash
    make keychron/v3_max/iso_encoder:keychron:flash
    make keychron/v3_max/jis_encoder:keychron:flash
