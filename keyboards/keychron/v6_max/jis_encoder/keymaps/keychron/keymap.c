...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_jis_113(
        ...
        KC_LCTL,  KC_LOPTN, KC_LCMMD, KC_LNG2,                      KC_SPC,                        KC_LNG1, KC_RCMMD, KC_ROPTN, FN_MAC,   KC_RCTL,             KC_LEFT,  KC_DOWN,  KC_RGHT,   KC_P0,              KC_PDOT,  KC_PENT),
    ...
    [WIN_BASE] = LAYOUT_jis_113(
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_BSLS,  KC_ENT,                                             KC_P4,    KC_P5,    KC_P6,    KC_PPLS,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_INT1,  KC_RSFT,                       KC_UP,               KC_P1,    KC_P2,    KC_P3,
        KC_LCTL,  KC_LWIN,  KC_LALT,  KC_INT5,                      KC_SPC,                       KC_INT4,  KC_RALT,  KC_RWIN,  FN_WIN,   KC_RCTL,             KC_LEFT,  KC_DOWN,  KC_RGHT,   KC_P0,              KC_PDOT,  KC_PENT),
