...
![Keychron Q12 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/Q12-Max-1.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/q12_max/ansi_encoder:keychron
    make keychron/q12_max/iso_encoder:keychron

Flashing example for this keyboard:

    make keychron/q12_max/ansi_encoder:keychron:flash
     make keychron/q12_max/iso_encoder:keychron:flash
