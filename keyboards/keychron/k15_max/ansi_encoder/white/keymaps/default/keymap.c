...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_90(
        KC_MUTE,  KC_ESC,   KC_BRID,  KC_BRIU,  KC_MCTRL, KC_LNPAD, BL_DOWN,  BL_UP,    KC_MPRV,  KC_MPLY, KC_MNXT,   KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_INS,             KC_DEL,
    ...
    [MAC_FN] = LAYOUT_ansi_90(
        ...
        _______,  BL_TOGG,  BL_STEP,  BL_UP,    _______,  _______,  BL_SPI,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  BL_DOWN,  _______,  _______,  BL_SPD,   _______,  _______,  _______,  _______,  _______,  _______,            _______,            KC_END,
