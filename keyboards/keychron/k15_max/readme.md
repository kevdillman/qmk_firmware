...
![Keychron K15 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/K15-Max-page7.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/k15_max/ansi_encoder/rgb:keychron
    make keychron/k15_max/ansi_encoder/white:keychron
    make keychron/k15_max/iso_encoder/rgb:keychron
    make keychron/k15_max/iso_encoder/white:keychron
    make keychron/k15_max/jis_encoder/rgb:keychron
    make keychron/k15_max/jis_encoder/white:keychron

Flashing example for this keyboard:

    make keychron/k15_max/ansi_encoder/rgb:keychron:flash
    make keychron/k15_max/ansi_encoder/white:keychron:flash
    make keychron/k15_max/iso_encoder/rgb:keychron:flash
    make keychron/k15_max/iso_encoder/white:keychron:flash
    make keychron/k15_max/jis_encoder/rgb:keychron:flash
    make keychron/k15_max/jis_encoder/white:keychron:flash
